    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <?php
                ...
                if (isset($_POST['Submit'])) {
                    ...
                    "INSERT INTO dokter( id_dokter , nama_dokter , alamat_dokter , spesialis_dokter) 
                    VALUES('$id_dokter','$nama_dokter','$alamat_dokter' , '$spesialis_dokter')");
                    ...
                    <div class="mx-auto w-3/5 mt-4">
                        <div class="p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
                            <span class="font-medium">Berhasil!</span> Data Dokter Berhasil ditambah.
                        </div>
                    </div>
                
                    ';
 
                    echo '<meta http-equiv="refresh" content="2;url=../Pages/Dokter.php">';
        ...
        <div class="bg-white mt-12 rounded-lg shadow-xl w-3/5 mx-auto">
            ...
            <div class="px-8 py-6 ">
                <form action="Add_Data_Dokter.php" method="post" name="form1">
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="id_dokter" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="nama_dokter" class="block py-2.5 px-0 w-full text-sm 
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="alamat_dokter" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label class="absolute text-sm text-gray-500 duration-300 transform -translate-y-6 
                        scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 
                        peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="spesialis_dokter" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label class="absolute text-sm text-gray-500 duration-300 transform -translate-y-6 
                        scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 
                        peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 
