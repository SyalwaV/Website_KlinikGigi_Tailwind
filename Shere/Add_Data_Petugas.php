    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <?php
            ...
            if (isset($_POST['Submit'])) {
                ...
                $jam_jaga = date('H:i:s', strtotime($_POST['jam_jaga']));
                $jam_kelar_jaga = date('H:i:s', strtotime($_POST['jam_kelar_jaga']));
                ...
                "INSERT INTO petugas (id_petugas  , nama_petugas , alamat_petugas , jam_jaga , jam_kelar_jaga	) 
                VALUES('$id_petugas','$nama_petugas','$alamat_petugas' , ' $jam_jaga' , '$jam_kelar_jaga')");
                ...
                if ($result) {
                    ...
                    <div class="mx-auto w-3/5 mt-4">
                        <div class="p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
                            <span class="font-medium">Berhasil!</span> Data Petugas Berhasil ditambah.
                        </div>
                    </div>

                    ';

                    echo '<meta http-equiv="refresh" content="2;url=../Pages/Petugas.php"">';
                }
        ...
        <div class="bg-white mt-12 rounded-lg shadow-xl w-3/5 mx-auto">
            ...
            <div class="px-8 py-4">
                <p class="text-slate-800 text-xl flex ">
                    <a class="pt-2 mr-3" href="../Pages/Petugas.php">
            ...
            <div class="px-8 py-6 ">
                <form action="Add_Data_Petugas.php" method="post" name="form1">
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="id_petugas" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        peer-focus:scale-75 peer-focus:-translate-y-6">Id Petugas</label>
                    </div>
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="nama_petugas" class="block py-2.5 px-0 w-full text-sm 
                        ...
                        peer-focus:-translate-y-6">Nama Petugas</label>
                    </div>
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="alamat_petugas" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label class="absolute text-sm text-gray-500 duration-300 transform -translate-y-6 
                        scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 
                        peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 
                        peer-focus:-translate-y-6">Alamat Petugas</label>
                    </div>
                    <div class="relative z-0 mb-6 w-full group">
                        <label  class="block text-sm font-medium text-gray-900 ">Jam Jaga</label>
                        <div class="flex space-x-6">

                            <input type="time" name="jam_jaga" class="block py-2.5 px-0 w-1/2 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            <span class="text-sm pt-4">Sampai</span>
                            <input type="time" name="jam_kelar_jaga" class="block py-2.5 px-0 w-1/2 text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
