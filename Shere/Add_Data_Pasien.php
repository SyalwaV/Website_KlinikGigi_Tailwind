    ...
    <div class="min-h-screen bg-gray-100">
            ...
            <div class="container flex flex-wrap justify-between items-center mx-auto md:px-24 h-12">
                ...
                <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
                    <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        ...
                        <li>
                            <a href="../Pages/pasien.php" class="block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-slate-200 md:p-0 ">Dokter</a>
                        </li>
                        <li>
        ...
        <?php
            ...
            if (isset($_POST['Submit'])) {
                ...
                "INSERT INTO pasien (id_pasien , nama_pasien , alamat_pasien , tanggal_datang , keluhan_pasien	, id_dokter  ) 
                VALUES('$id_pasien','$nama_pasien','$alamat_pasien' , ' $tanggal_datang' , '$keluhan_pasien' , '$id_dokter')");
                ...
                if ($result) {
                    ...
                    <div class="mx-auto w-3/5 mt-4">
                        <div class="p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
                            <span class="font-medium">Berhasil!</span> Data Pasien Berhasil ditambah.
                        </div>
                    </div>
        ...
        <div class="bg-white mt-12 rounded-lg shadow-xl w-3/5 mx-auto">
            ...
            <div class="px-8 py-6 ">
                <form action="Add_Data_pasien.php" method="post" name="form1">
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="id_pasien" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        peer-focus:scale-75 peer-focus:-translate-y-6">Id Pasien</label>
                    </div>
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="nama_pasien" class="block py-2.5 px-0 w-full text-sm 
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="alamat_pasien" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label class="absolute text-sm text-gray-500 duration-300 transform -translate-y-6 
                        scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 
                        peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="keluhan_pasien" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label class="absolute text-sm text-gray-500 duration-300 transform -translate-y-6 
                        scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 
                        peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        ...
                        <select name="id_dokter"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                            ...
                            ?>
                            <option value="<?php echo $data['id_dokter'] ?>"><?php echo $data['nama_dokter'] . ' ( Spesialis ' . $data['spesialis_dokter'] . ' )'?></option>
