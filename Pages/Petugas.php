    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <?php
            ...
            if (isset ($_GET['id'])) {
                ...
                $result = mysqli_query($koneksi,"DELETE from petugas where id_petugas='$id'");
        ...
        <div class="md:mx-24 bg-white mt-8 rounded-lg shadow-xl">
            ...
            <div class="mt-6 mx-8">
                <a class="px-4 py-2 bg-slate-500 hover:bg-slate-700 rounded-lg text-white"
                 href="../Shere/Add_Data_Petugas.php">Tambah Data</a>
            </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 table-fixed ">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 ">
                                    ...
                                    <tr class="hover:bg-gray-100 ">
                                        ...
                                        <td class="py-4 px-6 text-sm font-medium text-gray-500 whitespace-nowrap "><?php echo $data['alamat_petugas'] ?></td>
                                        <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap "><?php echo $data['jam_jaga'] . ' s.d ' .  $data['jam_kelar_jaga']?></td>
                                        <td class="py-4 px-6 text-sm font-medium whitespace-nowrap border flex justify-center space-x-2">
                                            <a href="../Shere/Edit_Data_Petugas.php?id=<?php echo $data['id_petugas'] ?>" class="bg-amber-400 hover:bg-amber-600  p-1.5 rounded-sm text-black   hover:text-white">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                </svg>
                                            </a>
                                            <button data-modal-toggle="modalhapus<?php echo $data['id_petugas'] ?>" type="button" class="bg-red-500 hover:bg-red-700 p-1.5 rounded-sm text-white hover:underline">
                                            ...
                                            <!-- modal -->
                                            <div id="modalhapus<?php echo $data['id_petugas'] ?>" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-1 z-50 justify-center items-center 
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow ">
                                                        ...
                                                        <div class="flex justify-between items-start p-5 rounded-t border-b">
                                                            <h3 class="text-xl font-semibold text-gray-900 lg:text-2xl ">
                                                                Hapus Data <?php echo $data['nama_petugas'] ?>
                                                            </h3>
                                                            ...
                                                            data-modal-toggle="modalhapus<?php echo $data['id_petugas'] ?>">
                                                        ...
                                                        <div class="p-6  text-center">
                                                            <p class=" leading-relaxed text-gray-700">
                                                                Apakah Anda Ingin Menghapus Data <?php echo $data['nama_petugas'] ?> ?
                                                            </p>
                                                        </div>
                                                        <!-- Modal footer -->
                                                        <div class="flex justify-end p-6 space-x-2 rounded-b border-t border-gray-200">
                                                            <button data-modal-toggle="modalhapus<?php echo $data['id_petugas'] ?>" type="button" class="text-white bg-cyan-600 hover:bg-cyan-800 focus:ring-4 focus:ring-gray-300 rounded-lg border
                                                             border-gray-200 text-sm font-medium px-5 py-2.5  focus:z-10 ">Batalkan</button>
                                                            <a href="Petugas.php?id=<?php echo $data['id_petugas'] ?>" class="text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-blue-300 font-medium 
